...
"""
Gotcha Linux – GTK GUI (финальная версия)
- Проверка root
- Все вызовы append из потоков через GLib.idle_add
- Защита от множественных нажатий в Доступе
- Остановка атак через SIGKILL
- Вкладка Справка с открытием guide.html и scheme.html
"""
